...
function aoe(cx) {
    ...
    c1.attr('points', (cx + 75) + ',90 ' + (cx) + ',25 ' + (cx - 75) + ',90 ').attr('fill', 'pink').attr('stroke', 'pink').attr('stroke-width', 5);
...
c2.attr('x', 250).attr('y', 90).attr('width', 150).attr('height', 100).attr('fill', 'blue').attr('stroke', 'pink').attr('stroke-width', 5).attr('fill-opacity', 0.1).attr('stroke-opacity', 0.9);
var c3 = svgctrl.append('rect');
c3.attr('x', 300).attr('y', 140).attr('width', 50).attr('height', 50).attr('fill', 'rgb(0,0,255)').attr('stroke-width', 3).attr('stroke', 'gb(32, 32, 244)');
var c4 = svgctrl.append('circle');
c4.attr('cx', 280).attr('cy', 115).attr('r', 10).attr('stroke', 'purple').attr('stroke-width', 3).attr('fill', 'purple');
var c5 = svgctrl.append('circle');
c5.attr('cx', 370).attr('cy', 115).attr('r', 10).attr('stroke', 'purple').attr('stroke-width', 3).attr('fill', 'purple');
...
//var box = document.querySelector("svgctrl")
